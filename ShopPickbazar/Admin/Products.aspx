<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Dashboard.Master" AutoEventWireup="true" CodeBehind="Products.aspx.cs" Inherits="ShopPickbazar.Admin.Products" %>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered" width="100%" cellspacing="0"
                            ...
                            <tbody>
                                <asp:Repeater ID="dataProducts" runat="server">
                                    <ItemTemplate>
                                        <tr>
                                            ...
                                            <td style="vertical-align: middle; text-align:center">
                                                <span class="<%# Eval("cssClass").ToString() %>">
                                            ...
                                            <td style="vertical-align: middle;" class="d-flex items-center justify-content-center">
                                                ...
                                                <asp:HyperLink runat="server" CssClass="btn btn-primary mr-2" NavigateUrl='<%#"ProductDetail.aspx?id=" + Eval("Id").ToString() %>'>
                                                ...
                                                <asp:HyperLink runat="server" CssClass="btn btn-success" NavigateUrl='<%#"UpdateProduct.aspx?id=" + Eval("Id").ToString() %>'>
